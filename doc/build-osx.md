# Mac OS X DudgCoind Build Instructions
...
* See readme-qt.rst for instructions on building DudgCoin QT, the
...
## Useful commands
    ...
    ./dudgcoind --help  # for a list of command-line options.
    ./dudgcoind -daemon # to start the dudgcoin daemon.
    ./dudgcoind help    # When the daemon is running, to get a list of RPC commands
